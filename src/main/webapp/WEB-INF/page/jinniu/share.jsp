	...
	<script type="text/javascript">
			...
			function initGrid() {
				$("#goods_list").jqGrid({
					url : dataUrl,
					datatype : "json",
					colNames : ['动态ID','动态首图','内容','被赞数', '浏览数', '评论数','用户id','状态','话题id','创建时间','操作'],
					colModel : [
						{name : 'id',index : 'id',align : "center",width : 25},
						{name : 'imgs',index : 'imgs',align : "center",width : 60,
						...
						{name : 'description',index : 'description',align : "center",width : 240},
						{name : 'praiseCount',index : 'praiseCount',align : "center",width : 30},
						{name : 'scanCount',index : 'scanCount',align : "center",width : 30},
						{name : 'commentCount',index : 'commentCount',align : "center",width : 30},
						{name : 'userId',index : 'userId',align : "center",width : 30},
						{name : 'status',index : 'status',align : "center",width : 30,
							formatter:function(cellvalue, options, rowObject){
								return formatterStatus(rowObject.status);
							},
						},
						{name : 'topicId',index : 'topicId',align : "center",width : 30,sortable:false},
						{name : 'createTime',index : 'createTime',align : "center",width : 50,sortable:false},
						{name : 'operate',index : 'operate',align : "center",width : 60,
							formatter:function(cellvalue, options, rowObject){
			...
			<form id="goods_search_form">
				<table>
					<tr>
						...
						<td>
							<input type="text" name="userId" id="filter_1">
						</td>
						...
						<td>
							<a style="height:18px;" href="javascript:;" id='search_btn' onclick="commonSearch('${path}share','#goods_search_form','#goods_list')">搜索</a>
						</td>
					</tr>
				</table>
			</form>
